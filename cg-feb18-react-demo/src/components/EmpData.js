...
// import Department from "../models/Department";
// import Employee from "../models/Employee";
// import { getEmpByIdService, getAllEmpsService, addEmpService,updateEmpService } from "../services/EmployeeService";
...
//     const [emp, setEmp] = useState(new Employee());
//     const [empToBeAdded, setEmpToBeAdded] = useState(new Employee());
//     const [empToBeUpdated, setEmpToBeUpdated] = useState(new Employee());
//     const [department, setDepartment] = useState(new Department());
//     const [allEmps, setAllEmps] = useState();
...
//             let empTemp = { ...empToBeUpdated, department };

//             updateEmpService(empTemp)

//                 .then((response) => {

//                     console.log(response.data);

//                     alert(`Employee with employeeId ${response.data.employeeId} updated successfully.`);

//                 })

//                 .catch(() => {

//                     setEmpToBeUpdated(empTemp);
...
//                             id="employeeId"
//                             name="employeeId"
//                             value={empToBeUpdated.employeeId}
//                             placeholder="Enter employee id"
//                             onChange={handleUpdateEmp}/>
//                     <input
//                         type="text"
//                         id="firstName"
//                         name="firstName"
//                         className="form-control mb-3 mt-3"
//                         value={empToBeUpdated.firstName}
//                         onChange={handleUpdateEmp}
//                         placeholder="Enter First Name" />
//                     <input
//                         type="number"
